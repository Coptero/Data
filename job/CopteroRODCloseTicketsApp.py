...
from CopteroRODCloseTicketsJob import CopteroRODCloseTicketsJob
...
class CopteroRODHelpdeskApp:
    ...
    def main():
        AppName = "Coptero ROD Close Tickets Batch"
        ...
        if any(s3filePath):
            ...
            CopteroRODCloseTicketsJob.runJob(sc, s3confPath, s3filePath)
        else:
            sys.exit(1)
